...
firebase.database().ref('/responses/').once('value').then(function(snapshot) {
        ...
        $("#question10").show();
        $("#text10").html("Question 10: " + (document.getElementById("questionText").innerHTML = questionArray[9]) + "<br>Your Answer: " + selectedAnswers[9] + "<br>Correct Answer: d) Vertex: (0,0); Focus: (0,-1/2); Directrix: y = 1/2");
