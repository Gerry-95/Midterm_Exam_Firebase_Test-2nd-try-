...
firebase.database().ref('/responses/').once('value').then(function(snapshot) {
        ...
        $("#question4").show();
        $("#text4").html("Question 4: " + (document.getElementById("questionText").innerHTML = questionArray[3]) + (document.getElementById("img44").innerHTML = $(".img").show())  + "<br>Your Answer: " + selectedAnswers[3] + "<br>Correct Answer: b) (x + 2)(x - 2)/2(x - 5)");
