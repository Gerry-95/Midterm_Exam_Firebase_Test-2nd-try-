...
firebase.database().ref('/responses/').once('value').then(function(snapshot) {
        ...
        $("#advice1").html("If you got this one wrong: " + "<br>Think of two numbers that add to be the b-value (in this case, 4) but multiply to be the c-value (also 4). Then you find out that x + those numbers are your factors ( (x + 2)(x + 2) would be correct). Then you set them equal to 0 and solve.");
        $("#question2").show();
        ...
        $("#advice2").html("If you got this one wrong: " + "</br>You must plug in the x-values into the equation to find y" + strsub2.sub() + " and y" + strsub1.sub() + " for the average rate of change (which is essentially the constant rate of change for quadratics) Try plugging in the x" + strsub2.sub() + " value in first, solve, then do x" + strsub1.sub() + " (I find it easier to visualize where everything's supposed to go if I do that, but do whatever helps you solve y" + strsub2.sub() + " - y" strsub1.sub() + "/x" + strsub2.sub() + " - x" + strsub1.sub() + ").");
        $("#question3").show();
        ...
        $("#advice3").html("If you got this one wrong: " + );
        $("#question4").show();
        ...
        $("#advice4").html("If you got this one wrong: " + );
        $("#question5").show();
        ...
        $("#advice5").html("If you got this one wrong: " + );
        $("#question6").show();
        ...
        $("#advice6").html("If you got this one wrong: " + );
        $("#question7").show();
        ...
        $("#advice7").html("If you got this one wrong: " + );
        $("#question8").show();
        ...
        $("#advice8").html("If you got this one wrong: " + );
        $("#question9").show();
        ...
        $("#advice9").html("If you got this one wrong: " + );
        $("#question10").show();
        ...
        $("#advice10").html("If you got this one wrong: " + );
        };
    });
};
